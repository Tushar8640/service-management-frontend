  ...
  return (
    <Card className="text-black hover:shadow-xl p-2">
      <CardContent className="">
        <div className="grid md:grid-cols-3 md:items-center md:justify-items-stretch gap-2">
          <div className="flex  justify-start items-center space-x-2">
            <img
              src={cart?.serviceId?.image}
              alt="card image"
              className="w-14 h-14"
            />
            <div className="flex flex-col justify-start items-start">
              <p className="lg:text-center text-sm font-medium ">
                Title: {cart?.serviceId?.title}
              </p>
              <p className="lg:text-center mt-3 text-sm font-medium ">
                Category: {cart?.serviceId?.category}
              </p>
            </div>
          </div>
